      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-20">
          <div>
            ...
            <a href="/" className="hover:text-gray-200 mb-3 p-1 border border-white rounded-full flex items-center justify-center w-8 h-8">
              <FaLinkedinIn />
            </a>
            <ul>
            ...
            <div>
              <img src={logo} alt="OHM Biomedical Logo" className="mt-5 h-20" />
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex flex-col items-end text-sm mt-8">
